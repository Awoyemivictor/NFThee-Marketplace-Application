...
installController.mongotest = function (req, res) {
  ...
  let CONNECTION_URI = 'mongodb://' + data.username + ':' + dbPassword + '@' + data.host + ':' + data.port + '/' + data.database

    
  if (data.port === '---')
    // CONNECTION_URI = "mongodb+srv://rakeshlnwebworks:ZO1w7YWDqSEK1hpL@cluster0.d8heopu.mongodb.net/?retryWrites=true&w=majority";
