                     ...
                     &nbsp;&nbsp; <p>{data.nftId.name}</p>
                      {modalIsOpen && (
                        <div
                          ...
                          onClick={handleCloseModal}
                        >
                          <img src={data.nftId.uploadFile||require('../../../assets/images/user/avt-1.jpg')} style={{ maxWidth: "100%", maxHeight: "100%" }} />
                        </div>
                      )}
                    </>
                  );
...
const handleDelete = data => {
  Swal.fire({
      ...
      if (result.value) {
          // instance
          backendInstance.post(`/api/deleteReport?id=${data._id}`)
