...
const CreateNewItem = () => {
    ...
    useEffect(async () => {
        const fetchBlockchains = async () => {
            ...
            await instance.get('/api/getBlockchain').then(response => {
                ...
                res.map(blockchain => {
                    arr.push({value: blockchain.name, label: blockchain.name, image: blockchain.icon})
                })
                // console.info(arr)
                setBlockchains(arr)
            })
        ...
        const fetchCategories = async () => {
            ...
            instance.get('/api/getCategory').then(response => {
                let res = response.data.data
                res.map(category => {
                    arr.push({value: category.name, label: category.name, image: category.image})
                })
                console.info(arr)
                setCategories(arr)
            })
        ...
        const fetchData = async () => {
            ...
            await instance.get('/api/createCollection/all').then(response => {
                ...
                result.map((collection) => {
                    ...
                    arr.push({value: collection.name, label: collection.name, category: collection.category})
                })
                setCollections(arr)
            })
        }
    ...
    const handleSubmitNewItem = async () => {
        ...
        instance.post('/api/store', post).then(response => {
            Swal.fire({
                position: "top-center",
                icon: "success",
                title: "Successful",
    ...
    const handleCollectionBlockchain = option => {
        setCollectionData({
            ...collectionData,
    ...
    const deleteLevel = levelIndex => {
        if(itemData.levels.length>1){ setItemData({
           ...itemData,
    ...
    const addLevels = (e) => {
        setItemData({
          ...itemData,
          levels: [...itemData.levels, { levelServer: "", levelSpeed: "",levelUsername:"" }]
        });
      };
      ...
      const deleteAttribute = attrIndex => {
       if(itemData.attribute.length>1){ setItemData({
          ...itemData,
    ...
    const addStats = (e) => {
        setItemData({
          ...itemData,
          stats: [...itemData.stats, { statsServer: "", statsSpeed: "",statsUsername:"" }]
        });
      };
      const deleteStats = stateIndex => {
        if(itemData.stats.length>1){ setItemData({
           ...itemData,
                                                ...
                                                <div className="preview-card">
                                                    <div className="card-body">
                                                        <div className="name-content">
                                                            <h3>{itemData.name ? itemData.name : "Creative Art Collection"}</h3>
                                                            <p>
                                                                Owner <span>{user ? `${user.first_name} ${user.last_name}` : "Ralph Garraway"}</span>
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div className="card-media">
                                                            <a href="#">
                                                                <img
                                                                    src={itemData.uploadFile ? `${process.env.REACT_APP_BASE_URL}/${itemData.uploadFile.filename}` : "assets/images/artboard.png"}
                                                                    alt=""
                                                                    className="img-fluid"
                                                                />
                                                            </a>
                                                        ...
                                                        <div className="card-title">
                                                            <h3>{itemData.putOnMarketplace ? activeTab : "Not For Sale"}</h3>
                                                            <span>
                                                        ...
                                                        <a className="btn btn-violet" href="#">
                                                            {activeTab === "Fixed price" ? 'Post' : activeTab === "Open for bids" ? 'Make a bid' : 'Make bid'}
                                                        </a>
                                                        <div className="clear-all mt-2 d-flex align-items-center"
                                        ...
                                        <div className="col-md-8 col-lg-9">
                                            <div className="create-item-section">
                                                    ...
                                                    <div className="row mt-4">
                                                        <div className="col-lg-12 col-md-12">
                                                            <div>
                                                                ...
                                                                <label
                                                                    class="uploadFile file-drop overflow-hidden position-relative">
                                                                    <h4 id="file_name">PNG, GIF, WEBP, MP4, Max
                                                                        100Mb.</h4>
                                                                    {uploadedFile ? (
                                                                        <img
                                                ...
                                                <div className="create-item-content border-bottom pb-3 mb-3">
                                                    ...
                                                    <h5 className="create-item-subtitle">
                                                        Choose the most suitable blockchain for your
                                                        needs. you need to sign in for creator
                                                    </h5>
                                                    <Select
                                                    ...
                                                    <div className="row">
                                                        <div className="create-item-tab">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <div
                                                                        className="create-item-content border-bottom mb-3 pb-3">
                                                                        <h4 className="create-item-title mb-3">
                                                                            Price
                                                                        </h4>
                                                                        ...
                                                                        <div
                                                                            className="d-flex align-items-center price-detail">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div className="row">
                                                                            ...
                                                                            <div className="col-lg-6 col-md-6">
                                                                                ...
                                                                                <select onChange={handleFinishDate}
                                                                                        className="form-select form-control d-block">
                                                                                    <option
                                                                                        value="Right after listing"
                                                                                        selected>
                                                    ...
                                                    <div className="create-item-content border-bottom mb-3 pb-3">
                                                        <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <h5 className="create-item-subtitle mb-0">
                                                                    Numerical traits that show as per progress
                                                                    bar
                                                                </h5>
                                                            </div>
                                                            <Link
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                              ...
                              <label className="switch">
                                ...
                                <span className="slider round" />
                                                    ...
                                                    <div className="create-item-content border-bottom pb-3 mb-3">
                                                        <div
                                                            className="d-lg-flex d-md-flex justify-content-between align-items-center">
                                                            <div>
                                                                <h4 className="create-item-title">
                                    ...
                                    <div className="create-item-content border-bottom pb-3 mb-3">
                                        ...
                                        <div className="create-item-content border-bottom pb-3 mb-3">
                                            ...
                                            <div className="row mt-4">
                                                <div className="col-lg-12 col-md-12 mb-lg-0 mb-4">
                                                    <label
                                                        className="img-upload up-box1 overflow-hidden"
                                                    >
                                        ...
                                        <div className="create-item-content border-bottom pb-3 mb-3">
                                            ...
                                            <div className="row mt-4">
                                                <div className="col-lg-12 col-md-12 mb-lg-0 mb-4">
                                                    <label
                                                        className="img-upload up-box2 overflow-hidden"
                                                    >
                                        ...
                                        <div className="create-item-content border-bottom pb-3 mb-3">
                                            ...
                                            <div className="row mt-4">
                                                <div className="col-lg-12 col-md-12 mb-lg-0 mb-4">
                                                    <label
                                                        className="img-upload up-box3 overflow-hidden"
                                                    >
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-4 col-md-4">
                                                            <div className="display-theme-content">
                                                                <label className="w-100 mb-0" id="padded-theme"
                                                        ...
                                                        <div className="col-lg-4 col-md-4">
                                                            <div className="display-theme-content">
                                                                <label className="w-100 mb-0" id="covered-theme"
                                                                       onClick={handleDisplayTheme}>
                                                                    <input
                                                                        name="display_theme"
                                                                        value="theme3"
                            ...
                            <span class="input-group-text" id="basic-addon1">
                              X
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e)=>handleAttributeChange(attrIndex, "attrType", e.target.value)}
                                                        type="text"
                                        ...
                                        <div className="col-md-8 ps-lg-0">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e)=>handleAttributeChange(attrIndex, "attrName", e.target.value)}
                                                    // value={name}
                                                    ...
                                                    style={{borderRadius: "0.25rem"}}
                                                />
                                            {itemData.attribute.length===1?"":<button onClick={(e)=>deleteAttribute(attrIndex)}>-</button>}
                                            </div>
                                        </div>
                                    </div>
                                    ))}
                                        ...
                                        <div className="col-md-4 pe-lg-2">
                                            <div class="input-group mb-3">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e)=>handleLevelChange(levelIndex, "levelSpeed", e.target.value)}
                                                    class="form-control shadow-none"
                                                    placeholder="Speed"
                                                    aria-label="Username"
                                                    aria-describedby="basic-addon1"
                                        ...
                                        <div className="col-md-8 ps-lg-0">
                                            <div class="input-group mb-3">
                                                <input
                                                    ...
                                                    onChange={(e)=>handleLevelChange(levelIndex, "levelUsername", e.target.value)}
                                                    class="form-control"
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e)=>handleLevelChange(levelIndex, "levelServer", e.target.value)}
                                                    class="form-control"
                                                    placeholder="Server"
                                                    // aria-label="Server"
                                                    style={{borderRadius: "0.25rem"}}
                                                    // defaultValue="5"
                                                />
                                                  {itemData.levels.length===1?"":<button onClick={(e)=>deleteLevel(levelIndex)}>-</button>}
                                            </div>
                                        ...
                                        <div className="col-md-4 pe-lg-2">
                                            <div class="input-group mb-3">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e)=>handleStatsChange(stateIndex, "statsSpeed", e.target.value)}
                                                    class="form-control shadow-none"
                                                    placeholder="Speed"
                                                    aria-label="Username"
                                                    aria-describedby="basic-addon1"
                                        ...
                                        <div className="col-md-8 ps-lg-0">
                                            <div class="input-group mb-3">
                                                <input
                                                    ...
                                                    onChange={(e)=>handleStatsChange(stateIndex, "statsUsername", e.target.value)}
                                                    class="form-control"
                                                    placeholder="Username"
                                                    aria-label="Username"
                                                    style={{borderRadius: "0.25rem"}}
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e)=>handleStatsChange(stateIndex, "statsServer", e.target.value)}
                                                    class="form-control"
                                                    placeholder="Server"
                                                    aria-label="Server"
                                                    style={{borderRadius: "0.25rem"}}
                                                    defaultValue="5"
                                                /> {itemData.stats.length===1?"":<button onClick={(e)=>deleteStats(stateIndex)}>-</button>}
                                            </div>
                                            {/* <input type="text" className="form-control shadow-none" placeholder="Name" style={{ borderRadius: "0.25rem" }} /> */}
                                        </div>
                                    </div>
