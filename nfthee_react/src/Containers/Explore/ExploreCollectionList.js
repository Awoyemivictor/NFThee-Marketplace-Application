        ...
        <div className="row">
            {slice.map((collection, index) => {
                return (
                    <>
                        <div
                            className="col-lg-4 col-md-4 my-1"
                            key={index}
                        >
                            <div className>
                                    ...
                                    <Link to={`/explorefilter/${collection._id}`}>
                                        <div className="tabbable-card">
                                            ...
                                            <div className="card-body pt-5">
                                                <img
                                                    src={collection.logo_image?collection.logo_image:"assets/images/avt-4.jpg"}
                                                ...
                                                <h6 className="card-title2">
                                                    {collection.user ? collection.user.user_name : "undefined"}
                                                </h6>
                ...
                <div className="col-lg-6 col-md-6 mx-auto">
                    {collections.length > 6 && (
                        <button
                            ...
                            // onClick={loadMore}
                            onClick={() => noOfElement > collections.length ? setNoOfElement(6) : setNoOfElement(noOfElement + 6)}
                        >
