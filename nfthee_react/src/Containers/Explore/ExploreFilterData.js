...
// ];
  ...
  export const FilterCard = ({_id, uploadFile,designation,name,likes, setliked,putOnMarketplace,currentOwner}) => {
                    ...
                    <div className="meta-info m-t-24">
                        <div className="meta-info-wrapper">
                            ...
                            <div className="eth-price">
                                <h6> <img src="/assets/images/icons/ethereum-big.png" alt="" className="me-1" /> {putOnMarketplace?.price || putOnMarketplace?.Bid_price} </h6>
                            </div>
