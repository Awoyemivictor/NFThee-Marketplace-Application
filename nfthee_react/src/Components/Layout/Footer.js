          ...
          <div className="footer-top">
            <div className="row">
              ...
              <div className="col-lg-1 col-md-4 col-sm-5 col-5">
                <div className="widget widget-menu ps-lg-4">
              ...
              <div className="col-lg-1 col-md-4 col-sm-7 col-7">
                <div className="widget widget-menu ps-lg-5">
              ...
              </div><div className="col-lg-2 col-md-6 col-sm-7 col-12">
